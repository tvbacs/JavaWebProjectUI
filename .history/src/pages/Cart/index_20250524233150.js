...
import { formatPrice, formatImageUrl, calculateTotalPrice, parsePrice } from "@/utils/formatPrice";
...
function CartPage() {
  ...
  const purchasedItems = selectedCartItems.map(item => `${item.electronic.name} SL ${item.quantity}`);
