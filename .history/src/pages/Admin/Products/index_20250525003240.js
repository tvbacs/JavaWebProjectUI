          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.id}>
                ...
                <td>
                  <span className={cx("quantity", getStatusColor(product.status, product.quantity))}>
                    {product.quantity}
                  </span>
                </td>
                <td>
                  <span className={cx("status", getStatusColor(product.status, product.quantity))}>
                    {getStatusText(product.status, product.quantity)}
                  </span>
                </td>
                <td>
